...
export const getRotationIconSvgDataUrl = (degree: number) => {
  ...
  const base64 = 'data:image/svg+xml,' + encodeURIComponent(svgStr);
  rotationIconCache.set(degree, base64);
  return base64;
};
